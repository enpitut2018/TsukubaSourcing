...
class JobcommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jobcomment" do
    assert_difference('Jobcomment.count') do
      post jobcomments_url, params: { jobcomment: { comment: @jobcomment.comment, job_id: @jobcomment.job_id, star: @jobcomment.star } }
    end
  ...
  test "should update jobcomment" do
    patch jobcomment_url(@jobcomment), params: { jobcomment: { comment: @jobcomment.comment, job_id: @jobcomment.job_id, star: @jobcomment.star } }
